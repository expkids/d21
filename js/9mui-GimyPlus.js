var rule = {
    title: '劇迷Plus (gimyplus)',
    host: 'https://gimyplus.com/',
    url: '/type/fyclass',
    searchUrl: '/search/-------------.html?wd=**', 
    filterable: 1,
    filter_url: 'show/{{fl.cateId}}-{{fl.area}}-------{{fl.cateIdMain}}---{{fl.year}}.html',	
	///show/13-中國大陸-time------2---2026.html
    filter: {
       ...
       "29":[{"key":"cateId","name":"類型","value":[{"n":"全部","v":"2"},{"n":"綜藝","v":"29"}]},
            {"key":"area","name":"地區","value":[{"n":"全部","v":""},{"n":"大陸","v":"大陸"},{"n":"中國","v":"中國"},{"n":"中國大陸","v":"中國大陸"},{"n":"韓國","v":"韓國"},{"n":"臺灣","v":"臺灣"},{"n":"美國","v":"美國"},{"n":"歐美","v":"歐美"},{"n":"日本","v":"日本"},{"n":"香港","v":"香港"}]},
